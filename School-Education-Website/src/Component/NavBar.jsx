...
export function NavBar(){
    ...
    return (
        <nav>
            ...
            <ul style={{ display: isOpen ? "block" : "none" }} className='navList'>
                        <li><a href="#">Home</a></li>
                        <li><a href="#">About</a></li>
                        <li><a href="#">Academic</a></li>
                        <li><a href="#">Admission</a></li>
